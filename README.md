...
* Test the API with a headless browser like Postman

## Notes

* The server should include appropriate CORS headers

## Examples

The returned data list should look like this:
...
The returned data item should look like this:
...
The returned error should look like this:
